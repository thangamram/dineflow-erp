...
export default function InventoryManagement() {
    const [activeTab, setActiveTab] = useState('overview'); // overview, stock, vendors, logs
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 tracking-tight">Inventory ERP</h1>
                    <p className="text-gray-500 font-medium mt-1">Enterprise-grade stock management & tracking</p>
                </div>
            ...
            <div className="flex bg-white rounded-xl shadow-sm border border-gray-100 p-1 w-max">
                <button
                    ...
                    className={`px-5 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'overview' ? 'bg-indigo-50 text-indigo-700 shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}
                >
                    Overview
                </button>
                <button
                    onClick={() => setActiveTab('stock')}
                    className={`px-5 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'stock' ? 'bg-indigo-50 text-indigo-700 shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}
                >
                    Inventory
                </button>
            </div>
